...
export default function PdfToPngPage() {
  ...
  async function loadPdf(selectedFiles: File[]) {
    ...
    try {
      ...
      const res = await fetch("/api/pdf-to-png", {
        method: "POST",
        body: formData,
      });
  ...
  return (
    ...
    >
      {!isSignedIn && (
        <div className="mb-8 rounded-3xl border border-blue-200 bg-blue-50 p-6 text-center">
          ...
          <h2 className="text-2xl font-bold text-zinc-900">
            Create a free account to convert PDFs to PNG
          </h2>
      ...
      <ToolSeo
        tool="PDF to PNG"
        description="Convert PDF pages into PNG images online for free with PDFRocket."
      />
    </ToolPage>
  );
}